...
<<figsetup,rgl=TRUE,eval=TRUE,echo=TRUE,results='hide',warning=FALSE,message=FALSE, echo=FALSE,dev='png', fig.width=4, fig.height=4, out.width='.5\\linewidth'>>=
####################################################
...
library(xtable)
mytbl<-xtable(signifnetworkdescriptor$network)
print(mytbl)
@ 
