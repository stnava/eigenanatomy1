...
How do the individual values across this network vary across the population?

<<spider,results='hide',echo=TRUE,warning=FALSE,message=FALSE>>=
...
stars( clustmat,main = "Network Thickness: Control vs MCI", flip.labels = FALSE, radius = FALSE, key.loc=c(20,1) )
@
